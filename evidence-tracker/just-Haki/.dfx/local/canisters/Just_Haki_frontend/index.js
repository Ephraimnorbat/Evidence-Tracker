...
import { idlFactory } from './Just_Haki_frontend.did.js';
export { idlFactory } from './Just_Haki_frontend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.JUST_HAKI_FRONTEND_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./Just_Haki_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the Just_Haki_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./Just_Haki_frontend.did.js")._SERVICE>}
 */
export const Just_Haki_frontend = createActor(canisterId);
